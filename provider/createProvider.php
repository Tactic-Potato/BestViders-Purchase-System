...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $fiscalName = mysqli_real_escape_string($db, $_POST['fiscalName']);
    $numTel = mysqli_real_escape_string($db, $_POST['numTel']);
    $email = mysqli_real_escape_string($db, $_POST['email']);

    // Insertar nuevo proveedor en la tabla PROVIDER
    $insert_query = "INSERT INTO provider (fiscalName, numTel, email) VALUES ('$fiscalName', '$numTel', '$email')";
    ...
    <div id="formCard">
        <form id="providerForm" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="fiscalName" id="fiscalName" placeholder="Enter fiscal name" required>
            </div>
