                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) { ?>
                        <tr>
                            ...
                            <td>$<?= number_format(htmlspecialchars($row['initialAmount']), 2) ?></td>
                            <td>$<?= number_format(htmlspecialchars($row['budgetRemain']), 2) ?></td>
                            <td><?= htmlspecialchars($row['budgetMonth']) ?></td>
                            <td><?= htmlspecialchars($row['budgetYear']) ?></td>
